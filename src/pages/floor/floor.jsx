...
import FloorTable from "../../components/tables/floor/floordetailtable";
...
import FloorModal from "./FloorModel/floormodel";
...
function FloorDetail() {
  ...
  const getData = async () => {
    try {
      const res = await axios.get(`${BASE_URL}${apiRoutes.floor}`);
      setData(res.data);
    } catch (error) {
        ...
        <Flex justify="space-between" direction="row" wrap="wrap">
          {selection.length > 0 ? (
            ...
            <>
              ...
              >
                All Floor Details <span style={{ color: "red" }}>*</span>
              </Text>
            </>
          )}
          <Group
