...
import classes from "./renovation.module.css";
...
import { RenovationEditModal } from "./editrenovation";
import { UnitAddModal } from "../addunit";
import { useNavigate } from "react-router-dom";

function RenovationDetail() {
  ...
  const getData = async () => {
    try {
      const res = await axios.get(`${BASE_URL}${apiRoutes.renovationunit}`);
      setData(res.data);
        ...
        <Flex justify="space-between" direction="row" wrap="wrap">
          {selection.length > 0 ? (
            ...
            <>
              ...
              >
                All Renovation Details <span style={{ color: "red" }}>*</span>
              </Text>
            </>
          )}
          <Group
